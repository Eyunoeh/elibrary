...
?>
    ...
    <body>
        ...
        <section class="home-section">
            ...
            // PRE NI ADD KO TO PARA PAG WALANG PROFILE ITO UN ALTERNATIVE PROFILE, di ko sure kung nagana pag napapaltan, pacheck nalang din kung napapaltan, basta nag alt eh hahah
            //dito at student ko lang nilagay, wala pa sa visitor
                                ...
                                <div class="row m-l-0 m-r-0">
                                    <div class="col-md-4 bg-c-lite-green user-profile1">
                                        <div class="card-block text-center text-white">
                                            <!-- MAY JS sa baba pre at nadagdagan ko onti tong code mo sa img path -->
                                            <div class="m-b-25"> <img src="<?php echo file_exists($new_str) ? $new_str : $path2 ?>" class="img-radius" alt="User-Profile-Image" width="150px"> </div>
                                            <h6 class="f-w-600 capitalize"><?php echo $name; ?></h6>
                                            <p>Librarian</p> <i class=" mdi mdi-square-edit-outline feather icon-edit m-t-10 f-16"></i>
                                        </div>
                                    </div>
                                    <div class="col-md-8">
                                        <div class="card-block">
                                            ...
                                            <div class="row" id="cont-btn">
                                                <div class="col-sm-3">
                                                    <a href="edit_profile.php"><button class="btn btn-dark " style="background-color: #238C8F;">Edit Profile</button></a>
                                                </div>
