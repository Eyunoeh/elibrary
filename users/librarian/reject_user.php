...
{
echo "<script type='text/javascript'>alert('User Rejected')</script>";
...
//Email body
	$mail->Body = "<h1>Your request has been rejected!!</h1></br><p>Please review your submitted details and try again.<br>Thank you.</p>";
//Add recipient
