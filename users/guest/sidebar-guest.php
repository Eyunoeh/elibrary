    ...
    <ul class="nav-links">
        ...
        <li>
            ...
            <ul class="sub-menu">
                ...
                <li><a href="AAbookavisit.php">Book a schedule</a></li>
                <li><a href="AAapproved.php">Approved</a></li>
                <li><a href="AApending.php">Pending</a></li>
                <li><a href="AAdenied.php">Denied</a></li>
                <li><a href="AAcancel.php">Canceled</a></li>
            </ul>
        </li>
        ...
        <li>
            ...
            <ul class="sub-menu blank">
                <li><a class="link_name" href="view_book.php">View Books</a></li>
            </ul>
        </li>
